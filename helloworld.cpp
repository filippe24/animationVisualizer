...
float verticesColorsAndTextureCoordinate[] = 
{
...
unsigned int indicesForVerticesColorsAndTextureCoordinate[] = 
{  
...
int main()
{
    ...
    */
    ...
    glBufferData(GL_ARRAY_BUFFER, sizeof(verticesColorsAndTextureCoordinate), verticesColorsAndTextureCoordinate, GL_STATIC_DRAW);

    glBindBuffer(GL_ELEMENT_ARRAY_BUFFER, EBO);
    glBufferData(GL_ELEMENT_ARRAY_BUFFER, sizeof(indicesForVerticesColorsAndTextureCoordinate), indicesForVerticesColorsAndTextureCoordinate, GL_STATIC_DRAW);
